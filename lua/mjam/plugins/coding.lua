    ...
    -- Auto pairs
    {
        ...
        config = function()
            require('nvim-autopairs').setup({
                ...
                disable_filetype = { "TelescopePrompt" },  -- Disable in telescope prompt
            })
    ...
    -- Comment toggling
    {
        ...
        config = function()
            require('Comment').setup({
                -- Enable comment string detection for certain filetypes
                pre_hook = require('ts_context_commentstring.integrations.comment_nvim').create_pre_hook(),
            })
        end,
        dependencies = 'JoosepAlviste/nvim-ts-context-commentstring'  -- Better comment string detection
    },
